...
> 归档说明（2026-08-15）：该设计对应已经落地的早期 YAML 框架，部分状态描述已过期。当前计划见 `backtest_executor/docs/README.md`。
...
```yaml
strategy:
  file: "strategies/etf_rotation/ETF_7star_opt.py"
...
{
  "metadata": {
    "strategy_path": "strategies/etf_rotation/ETF_7star_opt.py",
