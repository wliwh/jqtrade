...
DEFAULT_PACKAGE_DIR = (
    ...
    / "inputs"
    / "all_a_breadth"
    / "all_a_breadth_v1_20120101_20260814"
)
DEFAULT_OUTPUT_DIR = (
...
def run_analysis(package_dir, output_dir):
    ...
    labels = pd.read_csv(GROUND_TRUTH_DIR / "turning_point_labels.csv")
    outcomes = pd.read_csv(GROUND_TRUTH_DIR / "forward_outcomes.csv")
