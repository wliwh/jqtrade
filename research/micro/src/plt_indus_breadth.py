...
@dataclass
class Config:
    Indus_Pth: str = str(Path(__file__).resolve().parents[1] / 'artifacts' / 'data' / 'industries_score.csv')
    JSG_Color_Map = {
        '银行':'#009683',
        '煤炭':'#2a2a2a',
        '钢铁':'#4682b4',
...
if __name__ == "__main__":
    ...
    tend.render(Path(__file__).resolve().parents[1] / 'artifacts' / 'reports' / 'industries_breadth.html')
    pass
